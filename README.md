...
```
  ...
  -d [ --dictionary ] arg          Aruco board dictionary to use for detection 
                                   or printing when -p is defined. Formatted as
                                   'sizeXsize_combos'. Valid arguements 
                                   are:4X4_50
                                   4X4_100
                                   4X4_250
                                   4X4_1000
  ...
  -p [ --print ]                   Instead of performing position detection, 
                                   print the specified Aruco board to a PNG 
                                   file in the current directory and exit.
