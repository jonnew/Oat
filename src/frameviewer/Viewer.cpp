...
// TODO: Remove
//template<typename T>
//Viewer<T>::Viewer(Viewer&& v) :
//  sample_(std::move(v.sample_))
//, source_(std::move(v.source_))
//, tick_(std::move(v.tick_))
//, tock_(std::move(v.tock_))
//, running_(std::move(v.running_))
//, display_complete_(std::move(v.display_complete_))
//, display_cv_(std::move(v.display_cv_))
//, display_thread_(std::move(v.display_thread_))
//{
//    // Nothing
