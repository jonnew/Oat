...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        // For the recorder thread so we can listen to stdin over here Infinite
        // loop until ctrl-c or end of stream signal
        auto fut_record = 
            std::async(std::launch::async, [&recorder]{ run(recorder); });
        ...
        while (!quit) {
            ...
            switch (cmd) {
                case 'r' :
                {
                    ...
                    std::cout << "Recording " << recording_on << "\n";
                    break;
                }
            }
        }
